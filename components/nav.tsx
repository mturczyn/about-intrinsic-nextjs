...
export default async function Nav({ params }: { params: { locale: string } }) {
    ...
    return (
        <nav className="absolute flex h-16 w-full items-center border-b border-b-neutral-200 bg-white px-8 lg:px-96 [&>a]:rounded-lg [&>a:hover]:bg-neutral-200 [&>a]:p-3 [&>a]:transition-colors [&>a]:duration-1000">
