...
export default async function Nav({ params }: { params: { locale: string } }) {
    ...
    return (
        <nav className="bg-transparent absolute flex h-16 w-full items-center border-b border-b-neutral-200 bg-white px-8 lg:px-96 [&>a:hover]:bg-gray-200 [&>a]:p-3 [&>a]:transition-colors [&>a]:duration-1000">
